...
The WAI3 contract can be found at \`0x205E735a2C73228fA13EeB70720C7841BDf65EDB\` and you can view the contract code here: https://blockscout.taurus.autonomys.xyz/token/0x205E735a2C73228fA13EeB70720C7841BDf65EDB?tab=contract. Note you can also check out transfer activity and holders on the relevant tabs.

![wai](/developers/wai3/wai3-1.png)
...
To unwrap your WAI3 tokens (convert them back to the original tAI3 tokens), you'll need to interact with the \`withdraw\` function in the [WAI3 contract](https://blockscout.taurus.autonomys.xyz/token/0x205E735a2C73228fA13EeB70720C7841BDf65EDB?tab=write_contract). Here's how to do it.
