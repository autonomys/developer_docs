...
After the transaction, the NFT will appear in the recipient’s wallet. You can verify the transfer using the [Block explorer for the Autonomys testnet](https://blockscout.taurus.autonomys.xyz/)
