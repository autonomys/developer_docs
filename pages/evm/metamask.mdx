...
You have now successfully set up a MetaMask wallet and connected it to the Auto EVM! To deploy a smart contract, you first need to get a small amount of **tAI3** tokens in your wallet. Refer to the [faucet section](/develop/auto-evm/faucet) of the guide to learn more about getting testnet tokens.
