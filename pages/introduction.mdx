...
To start using Auto SDK, refer to our [Setup Instructions](/sdk) to clone the repository, install dependencies, and run tests. The SDK is designed to be developer-friendly, ensuring you can get up and running quickly.

## [Auto EVM - EVM Compatible Domain](/evm/introduction)
...
To start using Auto EVM, refer to our [Guides and Manuals](/evm/introduction).
