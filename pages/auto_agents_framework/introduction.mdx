...
```
*Note: You can find the .env.example file in the created character folder.*
...
twitter:
  ...
  POST_TWEETS: false
  # ... other configuration related to Twitter
...
llm:
 # If you plan to use directedTwitter workflow, you can configure the LLM nodes as follows:
  nodes:
    decision:
      provider: 'anthropic'
      model: 'claude-3-5-sonnet-latest'
      temperature: 0.2
  # ... other configuration related to LLM
  ...
